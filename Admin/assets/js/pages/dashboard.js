...
import createListenersGraph from "../helpers/listenersGraph";
...
export const Dashboard = function () {
  ...
  document.addEventListener('wpradio.accountLoaded', createListenersGraph);
  document.addEventListener('wpradio.accountLoaded', updateServerStatus);
  document.getElementById('wpradio-streamplayer').addEventListener("pause", function (event) {
